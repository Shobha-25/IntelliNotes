...
function Navbar() {
    ...
    return (
        ...
        theme-card flex items-center justify-between rounded-2xl px-8 py-4'>

            <div className='flex items-center gap-3'>
                <img src={logo} alt="examnotes" className='w-9 h-9' />
                <span className='theme-brand hidden text-2xl font-black md:block'>
                    IntelliNotes <span className='text-gray-400'></span>
                </span>
            </div>
            ...
            <div className='flex items-center gap-6 relative'>
                ...
                cursor-pointer'>
                  ...
                  rounded-full bg-white text-black text-xs font-bold'
                    >
                        <FaDollarSign className='text-[10px]' aria-hidden="true" />
                  ...
                  transition={{ duration: 0.2 }}
                    ...
                    p-4 text-slate-950'>
                        ...
                        <p className='text-sm text-slate-700 mb-4'>Use credits to generate AI notes, diagrams & PDFs.</p>
